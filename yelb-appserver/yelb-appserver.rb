...
configure :production do
  set :redishost => ENV['YELB_CACHE']
  set :port, 4567
  set :yelbdbhost => ENV['DATABASE_HOST']
  set :yelbdbport => ENV['DATABASE_PORT']
  set :yelbdbname => ENV['DATABASE_NAME'] || 'yelbdatabase'
  set :yelbdbuser => ENV['DATABASE_USERNAME'] || 'postgres'
  set :yelbdbpassword => ENV['DATABASE_PASSWORD'] || 'postgres_password'
  set :yelbddbrestaurants => ENV['YELB_DDB_RESTAURANTS']
  set :yelbddbcache => ENV['YELB_DDB_CACHE']
  set :awsregion => ENV['AWS_REGION']
end
configure :test do
  set :redishost => ENV['YELB_CACHE'] || "redis-server"
  set :port, 4567
  set :yelbdbhost => ENV['DATABASE_HOST'] || "yelb-db"
  set :yelbdbport => 5432
  set :yelbdbname => ENV['DATABASE_NAME'] || 'yelbdatabase'
  set :yelbdbuser => ENV['DATABASE_USERNAME'] || 'postgres'
  set :yelbdbpassword => ENV['DATABASE_PASSWORD'] || 'postgres_password'
